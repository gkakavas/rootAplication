...
public class Group {
    ...
    public boolean equals(Object o) {
        ...
        return new EqualsBuilder()
                ...
                .append(groupCreator, group.groupCreator)
                .append(groupCreationDate, group.groupCreationDate)
                .append(groupHasUsers.stream().map(User::getUserId).collect(Collectors.toSet()),
                        group.groupHasUsers.stream().map(User::getUserId).collect(Collectors.toSet()))
                .isEquals();
    }
}
