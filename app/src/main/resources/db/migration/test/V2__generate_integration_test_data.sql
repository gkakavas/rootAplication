...
INSERT INTO users(user_id,firstname,lastname,password,email,current_project,specialization,role_value,last_login,group_id,register_date,created_by)
VALUES ('16beb8e8-5020-48a6-a4a5-4a4cdc014774','firstname7', 'lastname7', 'password7', 'firstname7@email.com', 'current_project7', 'specialization7', 'USER', NULL, 'f8eac3d0-dd4e-4527-90aa-8c1a9f5e7a8f', CURRENT_TIMESTAMP, NULL);
