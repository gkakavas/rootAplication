...
INSERT INTO users(user_id,firstname,lastname,password,email,current_project,specialization,role_value,last_login,group_id,register_date,created_by)
VALUES ('e48cf7a3-3427-41d1-b26f-604e74cf6b8a','firstname3', 'lastname3', 'password3', 'firstname3@email.com', 'current_project3', 'specialization3', 'MANAGER', NULL, '19dd2267-8a90-47e5-9a2d-d9e767a109de', CURRENT_TIMESTAMP, NULL);

INSERT INTO users(user_id,firstname,lastname,password,email,current_project,specialization,role_value,last_login,group_id,register_date,created_by)
VALUES ('45b3df4b-f5bf-49d1-b928-16bbdb8e323e','firstname4', 'lastname4', 'password4', 'firstname4@email.com', 'current_project4', 'specialization4', 'HR', NULL, '19dd2267-8a90-47e5-9a2d-d9e767a109de', CURRENT_TIMESTAMP, NULL);

INSERT INTO users(user_id,firstname,lastname,password,email,current_project,specialization,role_value,last_login,group_id,register_date,created_by)
VALUES ('4d0dd9db-b777-4e8e-97ba-ef0b57534927','firstname5', 'lastname5', 'password5', 'firstname5@email.com', 'current_project5', 'specialization5', 'USER', NULL, '19dd2267-8a90-47e5-9a2d-d9e767a109de', CURRENT_TIMESTAMP, NULL);

INSERT INTO users(user_id,firstname,lastname,password,email,current_project,specialization,role_value,last_login,group_id,register_date,created_by)
VALUES ('10762127-c6ec-41f7-a893-44529e7c6283','firstname6', 'lastname6', 'password6', 'firstname6@email.com', 'current_project6', 'specialization6', 'USER', NULL, '19dd2267-8a90-47e5-9a2d-d9e767a109de', CURRENT_TIMESTAMP, NULL);
--inserts into events

INSERT INTO events(event_id, event_description, event_body, event_date_time, event_expiration, event_creator)
VALUES ('cfe4889d-3196-4ed0-8511-58d550d6cffb', 'event_description_1', 'event_body_1', '2023-10-15 12:34:56' , '2023-10-15 02:34:56', NULL);
